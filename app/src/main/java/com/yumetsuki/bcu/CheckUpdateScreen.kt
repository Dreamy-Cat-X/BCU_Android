...
import com.yumetsuki.bcu.androidutil.ApkUpdateChecker
...
import com.yumetsuki.bcu.androidutil.io.AssetDownloadService
import com.yumetsuki.bcu.androidutil.io.AssetException
import com.yumetsuki.bcu.androidutil.io.DefineItf
import com.yumetsuki.bcu.androidutil.io.ErrorLogWriter
import com.yumetsuki.bcu.androidutil.io.LanguageException
import com.yumetsuki.bcu.androidutil.pack.PackConflict
import com.yumetsuki.bcu.androidutil.supports.AnimatorConst
import com.yumetsuki.bcu.androidutil.supports.CustomAnimator
    ...
    private fun loadFile() {
        lifecycleScope.launch {
            ...
            withContext(Dispatchers.IO) {
                ...
                try {
                    Definer.init(this@CheckUpdateScreen, /*{ p -> runOnUiThread { if (p * 10000 != -1.0) prog.progress = (p * 10000).toInt() else prog.isIndeterminate = true } },*/ { t -> runOnUiThread { state.text = StaticStore.getLoadingText(this@CheckUpdateScreen, t) }})
