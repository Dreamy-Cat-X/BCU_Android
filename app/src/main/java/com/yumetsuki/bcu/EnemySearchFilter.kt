...
open class EnemySearchFilter : AppCompatActivity() {
    ...
    private val abils = arrayOf(intArrayOf(R.string.sch_abi_we, 1, Data.P_WEAK.toInt()), intArrayOf(R.string.sch_abi_fr, 1, Data.P_STOP.toInt()),
        ...
        intArrayOf(R.string.sch_abi_iw, 1, Data.P_IMUWEAK.toInt()), intArrayOf(R.string.sch_abi_if, 1, Data.P_IMUSTOP.toInt()), intArrayOf(R.string.sch_abi_is, 1, Data.P_IMUSLOW.toInt()),
        intArrayOf(R.string.sch_abi_ik, 1, Data.P_IMUKB.toInt()), intArrayOf(R.string.sch_abi_iwv, 1, Data.P_IMUWAVE.toInt(), 1, -1, 100), intArrayOf(R.string.sch_abi_imsu, 1, Data.P_IMUVOLC.toInt()),
        ...
        intArrayOf(R.string.sch_abi_stt, 1, Data.P_AI.toInt()))
