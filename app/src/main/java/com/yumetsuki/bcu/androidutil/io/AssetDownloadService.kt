...
class AssetDownloadService : Service() {
    companion object {
        const val PROGRESS_TEXT = "com.yumetsuki.bcu::Progress-Text"
        const val PROGRESS_PROGRESSION = "com.yumetsuki.bcu::Progress-Progression"
        const val SUCCESS = "com.yumetsuki.bcu::Success"
        const val FAILED = "com.yumetsuki.bcu::Failed"

        const val NOTIFICATION_ID = "com.yumetsuki.bcu::Download-Notification"
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        viewScope.launch {
            try {
                ...
                AssetLoader.removeTemp() //TODO: Make this optional
                AssetLoader.merge()
