...
class SearchFilter : AppCompatActivity() {
    ...
    private val abils = arrayOf(intArrayOf(1, Data.P_WEAK), intArrayOf(1, Data.P_STOP),
        intArrayOf(1, Data.P_SLOW), intArrayOf(0, Data.AB_ONLY), intArrayOf(0, Data.AB_GOOD),
        ...
        intArrayOf(1, Data.P_MINIVOLC), intArrayOf(1, Data.P_VOLC), intArrayOf(0, Data.AB_CSUR), intArrayOf(0, Data.AB_WAVES),
        intArrayOf(1, Data.P_SPIRIT), intArrayOf(0, Data.AB_BAKILL), intArrayOf(1, Data.P_BSTHUNT), intArrayOf(0, Data.AB_SKILL),
        intArrayOf(1, Data.P_IMUWEAK), intArrayOf(1, Data.P_IMUSTOP), intArrayOf(1, Data.P_IMUSLOW), intArrayOf(1, Data.P_IMUKB),
        intArrayOf(1, Data.P_IMUWAVE), intArrayOf(1, Data.P_IMUVOLC), intArrayOf(1, Data.P_IMUWARP),
        intArrayOf(1, Data.P_IMUCURSE), intArrayOf(1, Data.P_IMUPOIATK), intArrayOf(0, Data.AB_WKILL),
        intArrayOf(0, Data.AB_EKILL), intArrayOf(1, Data.P_POIATK), intArrayOf(1, Data.P_BARRIER),
        intArrayOf(1, Data.P_DEMONSHIELD), intArrayOf(1, Data.P_DEATHSURGE),
        intArrayOf(0, Data.AB_GLASS), intArrayOf(1, Data.P_BURROW), intArrayOf(1, Data.P_REVIVE),
        intArrayOf(0, Data.AB_GHOST), intArrayOf(0, Data.P_SNIPER), intArrayOf(1, Data.P_SEAL),
        intArrayOf(1, Data.P_TIME), intArrayOf(1, Data.P_SUMMON), intArrayOf(1, Data.P_MOVEWAVE),
        intArrayOf(1, Data.P_THEME), intArrayOf(1, Data.P_POISON), intArrayOf(1, Data.P_BOSS),
        intArrayOf(1, Data.P_ARMOR), intArrayOf(1, Data.P_SPEED), intArrayOf(1, Data.P_COUNTER),
        intArrayOf(1, Data.P_DMGCAP), intArrayOf(1, Data.P_DMGCUT), intArrayOf(1, Data.P_IMUMOVING),
        ...
        intArrayOf(1, Data.P_CRITI), intArrayOf(1, Data.P_IMUSUMMON), intArrayOf(1, Data.P_IMUARMOR),
        intArrayOf(1, Data.P_IMUSPEED))
